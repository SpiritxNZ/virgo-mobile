  ...
  return (
    <Layout style={[props.style, styles.swiper]}>
      <Swiper autoplay showsPagination={false}>
        <Layout style={styles.slide} title={<Text numberOfLines={1}>111</Text>}>
          <TouchableHighlight
            onPress={() => {
        ...
        <Layout style={styles.slide} title={<Text numberOfLines={1}>222</Text>}>
          <TouchableHighlight
            onPress={() => {
              props.navigation.navigate("Demo");
            }}
        ...
        <Layout style={styles.slide} title={<Text numberOfLines={1}>333</Text>}>
          <TouchableHighlight
            onPress={() => {
              props.navigation.navigate("Demo");
            }}
